<?php
  ...
  class Functions {
     ...
     * @param User $user
     */
    public function refreshSecurityToken(User $user) {
      $stoken = new UsernamePasswordToken($user, null, 'our_secured_area', $user->getRoles());
      $this->container->get('security.context')->setToken($stoken);
      $this->container->get('session')->set('_security_our_secured_area', serialize($stoken));
    }
...
// unmarked
     ...
     */
    public function replaceNonAlphanumericChars($string, $joker = "", $replacement = array(), $duplicate = true) {
    ...
    public function repairFileName($fileName) {
      ...
      $fileName = $this->replaceNonAlphanumericChars($fileName, "_", array("." => ".", "-" => "-"));
